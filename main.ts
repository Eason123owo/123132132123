...
sprites.onDestroyed(SpriteKind.E3, function (sprite) {
    ...
    game.showLongText("史萊姆王：#%*&#？", DialogLayout.Bottom)
    game.showLongText("（看起來對於我們", DialogLayout.Bottom)
    game.showLongText("聽不懂他說什麼感到生氣）", DialogLayout.Bottom)
...
sprites.onDestroyed(SpriteKind.E2, function (sprite) {
    ...
    if (controller.A.isPressed()) {
        ...
        game.showLongText("Ca王空手打斷螢光劍", DialogLayout.Bottom)
        ...
        game.showLongText("鑰匙總算湊齊了", DialogLayout.Bottom)
        k3 = sprites.create(img`
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
...
game.onUpdate(function () {
    if (mySprite.x >= 100) {
        ...
        game.showLongText("主角絕對不會死", DialogLayout.Bottom)
